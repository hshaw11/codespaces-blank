...
#An abstraction is a simplified representation of something more complex and complexity is a field from computer science which analyzes algorithms based on the amount resources.
#4. What does it mean when you encounter a syntax error?
#An error in the syntax of a sequence of characters that is supposed to be in a certain program.
#5. What is a variable? Provide an example of a variable in code.
#A symbolic representations of any numbers.
#6. Write a function in Python that when called will print out 
# your name.
print(haleem)
#7. What is a function definition and a function call?
#Defining it names the function and specifies what to do when the function is called. Calling the function actually performs the specified actions with the indicated parameters.
...
#Camelcase, Pascalcase, and Snakecase
...
#It returns information about the data structures used to store data elements in a program.