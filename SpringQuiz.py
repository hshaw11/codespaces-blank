...
# A for loop is used for iterating over a sequence(that is either a list, a set, or a string)
# For loop is used when the numbers of iterations is known, whereas execution is done in a while loop until the statement in the program is proved wrong.

# 2. Name and describe three python operator families. Plese write your response using complete
# sentences.

# Three python operators are Arithmetic Operators, Comparison Operators, and Loqical Operators.
